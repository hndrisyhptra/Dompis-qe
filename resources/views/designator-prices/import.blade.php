...
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        <h1 class="text-xl font-bold text-ink-900 dark:text-ink-50">Import KHS</h1>
        <p class="text-sm text-ink-500 dark:text-ink-400 mt-1">
            Upload file CSV dengan kolom: <code class="text-xs bg-ink-100 dark:bg-ink-800 px-1.5 py-0.5 rounded">designator_code, package_code, price</code>
        </p>
    </div>
    ...
    <x-card>
        <form method="POST" action="{{ route('designator-prices.import') }}" enctype="multipart/form-data" class="space-y-5">
            @csrf
